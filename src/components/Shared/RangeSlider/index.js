...
const RangeSlider = ({ min, max, minv, maxv, onChange, unit }) => {
    ...
    <RangeSliderContainer>
      ...
      <div className="display-values">
        <div className="display-min-value">
          <div className="display-value min-value">{minVal?.toFixed()} <span>{unit ? ` ${unit}`: '$'}</span></div>
        </div>
        <div className="display-to">to</div>
        <div className="display-max-value">
          <div className="display-value max-value">{maxVal?.toFixed()} <span>{unit ? ` ${unit}`: '$'}</span></div>
        </div>
      </div>
    </RangeSliderContainer>
  );
