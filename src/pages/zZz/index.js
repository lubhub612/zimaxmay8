    ...
    <MainArea>
      {popup && (
        <div className="popup-area">
          <div className="popup-area-inner">
            <span className="popup-close" onClick={() => setPopup(false)}>
              <svg
            ...
            <ul className="popup-body">
              <li>
                <span></span>
                <div className="pop-1x">
                  <div className="pop-2x">
                    <span></span>
                    <div className="pop-3x">
                      <span></span>
                      <span></span>
                    </div>
                  </div>
      ...
      <div className="x3-body">
        <div className="x3-body-inner">
          <div
            className="x3-item box_color_zZz"
